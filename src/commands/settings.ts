...
export default {
	...
	data: new SlashCommandBuilder()
        ...
        .addSubcommandGroup((subcommandgroup) => 
            subcommandgroup
                ...
                .setDescription("Enable or disable if the bot should announce user's birthday.")
                .addSubcommand((subcommand) => 
                    subcommand
                        ...
                        .addChannelOption((option) => 
                            option
                                .setName("channel")
                                .setDescription("The channel the announcements will be sent into.")
                                .setRequired(true)
                        )
                )
                .addSubcommand((subcommand) => 
	...
	async execute(interaction: ChatInputCommandInteraction) {
        ...
        if(member == undefined) {
            replyFailure(interaction, "Somehow you aren't in the guild you ran this command in.");
            return;
        }

        if(!member.permissions.has(PermissionFlagsBits.Administrator)){
            replyFailure(interaction, "You do not have the required permissions to run this command!");
            return;
        }
            ...
            case "birthday-announcements": {
                switch (interaction.options.getSubcommand()){
                    case "enable": {
                        ...
                        await setGuildBirthdayChannel(interaction.guildId as string, channel.id);
