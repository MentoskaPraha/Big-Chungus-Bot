...
export = {
	...
	data: new SlashCommandBuilder()
		...
		.addIntegerOption((option) =>
			option
				.setName("dice_size")
				.setDescription(
					"The size of the dice. Can be between 2 and 100."
				)
				.setRequired(true)
				.setMinValue(2)
				.setMaxValue(100)
		...
		.addIntegerOption((option) =>
			option
				...
				.setDescription(
					"Change the number of dice you want to roll, 1 by default, with a miximum of 15."
				)
				.setRequired(false)
				.setMinValue(1)
				.setMaxValue(15)
	...
	async execute(interaction: CommandInteraction) {
		...
		const embed = new EmbedBuilder()
			.setColor(diceRollerEmbedColor as ColorResolvable)
